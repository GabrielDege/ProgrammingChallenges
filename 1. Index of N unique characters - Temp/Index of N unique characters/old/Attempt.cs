namespace Index_of_N_unique_characters
{
    ...
    {
        /*  
            Find the index of the first occurrence of n unique characters (where a character is any lowercase letter).
            If there is no occurrence of n unique characters, then return -1.
            
            As an example: for stream = "mjqjpqmgbljsphdztnvjfqwrcgsmlb" and n = 14, the index would be 5.
